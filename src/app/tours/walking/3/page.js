            ...
            <Stack>
              ...
              <Flex direction={["column", "column", "column", "row"]} gap={10}>
                <Box>
                  ...
                  <UnorderedList>
                    {walkingData.Route3.items.map((item, index) => (
                ...
                <Box>
                  ...
                  <UnorderedList>
                    {walkingData.Route3.places.map((item) => (
